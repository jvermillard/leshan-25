...
public class EventServlet extends EventSourceServlet {
    ...
    public EventServlet(LeshanServer2 server, int securePort) {
        ...
        /*
         * coapMessageTracer = new CoapMessageTracer(server.getRegistrationService()); for (Endpoint endpoint :
         * server.coap().getServer().getEndpoints()) { endpoint.addInterceptor(coapMessageTracer); }
         */
    ...
    private class LeshanEventSource implements EventSource {
        ...
        public void onOpen(Emitter emitter) throws IOException {
            ...
            /*
             * if (endpoint != null) { coapMessageTracer.addListener(endpoint, new ClientCoapListener(endpoint)); }
             */
        }
