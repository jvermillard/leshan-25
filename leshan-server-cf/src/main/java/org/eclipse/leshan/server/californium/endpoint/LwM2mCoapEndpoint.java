...
public class LwM2mCoapEndpoint implements LwM2mEndpoint {
    ...
    public LwM2mCoapEndpoint(Protocol protocol, InetSocketAddress addr, Endpoint endpoint,
            CoapMessageTranslator translator, LwM2mEndpointToolbox toolbox,
            LwM2mNotificationReceiver notificationReceiver, ScheduledExecutorService executor) {
