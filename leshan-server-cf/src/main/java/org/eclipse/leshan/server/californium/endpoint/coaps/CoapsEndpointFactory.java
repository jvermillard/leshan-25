...
public class CoapsEndpointFactory implements CaliforniumEndpointFactory {
    ...
    private String loggingTag = null;
    protected DtlsConnectorConfig.Builder dtlsConfigBuilder;

    public CoapsEndpointFactory() {
        this(null);
    }

    public CoapsEndpointFactory(DtlsConnectorConfig.Builder dtlsConfig) {
    ...
    @Override
    public Endpoint createEndpoint(InetSocketAddress localSecureAddress, Configuration defaultConfiguration,
            ServerSecurityInfo serverSecurityInfo, LwM2mServer server, LwM2mNotificationReceiver notificationReceiver) {
        CoapEndpoint endpoint = createSecuredEndpointBuilder(
                handle(localSecureAddress, dtlsConfigBuilder, defaultConfiguration, server, serverSecurityInfo),
