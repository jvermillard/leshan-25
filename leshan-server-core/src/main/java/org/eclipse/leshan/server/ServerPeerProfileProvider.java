...
public class ServerPeerProfileProvider implements PeerProfileProvider {

    private RegistrationStore registrationStore;
    private LwM2mModelProvider modelProvider;

    public ServerPeerProfileProvider(RegistrationStore registrationStore, LwM2mModelProvider modelProvider) {
        this.registrationStore = registrationStore;
        this.modelProvider = modelProvider;
    }

    @Override
    public PeerProfile getProfile(Identity identity) {
