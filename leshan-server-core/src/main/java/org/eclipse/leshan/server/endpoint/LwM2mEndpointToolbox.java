...
public class LwM2mEndpointToolbox {
    ...
    public LwM2mEndpointToolbox(LwM2mDecoder decoder, LwM2mEncoder encoder, LwM2mLinkParser linkParser,
            PeerProfileProvider profileProvider) {
    ...
    public PeerProfileProvider getProfileProvider() {
